...
_BUR_PUBLIC plcbit FoldPushControl(float EncoderPosition, float OnPos, float OffPos);
...
_LOCAL double zz000E00010000;
_LOCAL double zz000E00010001;
_LOCAL double zz000E00010002;
_LOCAL double zz000E00010003;
_LOCAL struct f_trig zzFTR000010000;
_LOCAL struct f_trig zzFTR000010001;
...
_LOCAL float zz000800010002;
_LOCAL float zz000800010003;
_LOCAL float zz000800010004;
_LOCAL float zz000800010005;
