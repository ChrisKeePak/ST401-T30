...
#include "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/PatliteCom/Patelitest.h"
#line 1 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Stacklight/PatliteComm/Patelite.nodebug"
#line 2 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Stacklight/PatliteComm/Patelite.st"
void __BUR__ENTRY_INIT_FUNCT__(void){{


{int zzIndex; plcstring* zzLValue=(plcstring*)mb_station; plcstring* zzRValue=(plcstring*)"IF2.ST3"; for(zzIndex=0; zzIndex<7l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};


}}
#line 8 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Stacklight/PatliteComm/Patelite.nodebug"
#line 11 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Stacklight/PatliteComm/Patelite.st"
void _CYCLIC __BUR__ENTRY_CYCLIC_FUNCT__(void){{

if((((unsigned long)(unsigned char)gIsSimulated==(unsigned long)(unsigned char)0))){

if((((signed long)gModeControlInterface.Parameters.LightStackSelection!=(signed long)1))){
(ErrorCount=0);
(CommState=0);
(CurrentLightGroup=0);
...
if((gIO.DIs.SafetyOK^1)){
(NextLightGroup=4);

}else if(gHMI.BitmapSelectDatapoints.RunPress){
(NextLightGroup=3);

}else if((gIO.DIs.AirPressureOK&gAdhesiveCtrlInterface.Status.UnitReady)){
(NextLightGroup=2);
...
if((((signed long)NextLightGroup!=(signed long)CurrentLightGroup))){
...
(mbWriteSingleRegister_0.pStation=((unsigned long)(&mb_station)));
(mbWriteSingleRegister_0.startAddress=GROUP_REG_ADR);
(mbWriteSingleRegister_0.value=((unsigned short)CurrentLightGroup+GROUP_OFFSET));
mbWriteSingleRegister(&mbWriteSingleRegister_0);
if((((unsigned long)(unsigned short)mbWriteSingleRegister_0.status!=(unsigned long)(unsigned short)ERR_FUB_BUSY))){
if((((unsigned long)(unsigned short)mbWriteSingleRegister_0.status==(unsigned long)(unsigned short)0))){
...
if((((unsigned long)(unsigned short)ErrorCount>(unsigned long)(unsigned short)ERROR_COUNT_THRESH))){
(CommError=1);
}
...
if((CommError&~Edge0000100000&1?((Edge0000100000=CommError&1),1):((Edge0000100000=CommError&1),0))){
MpAlarmXSet(&gAlarmXCore,ALARM_PATLITE_COMMS);
}else if((~CommError&Edge0000100001&1?((Edge0000100001=CommError&1),1):((Edge0000100001=CommError&1),0))){
MpAlarmXReset(&gAlarmXCore,ALARM_PATLITE_COMMS);
}
}


}imp1_else9_1:imp1_end9_0:imp1_else0_0:imp1_end0_0:;}
#line 100 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Stacklight/PatliteComm/Patelite.nodebug"

void __AS__ImplInitPatelite_st(void){__BUR__ENTRY_INIT_FUNCT__();}
...
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/PatliteCom/Patelite.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/PatliteCom/Patelite.st.c\\\" \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Stacklight/PatliteComm/Patelite.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/PatliteCom/Patelite.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");

__asm__(".section \".plciec\"");
__asm__(".ascii \"plcdata_const 'GROUP_OFFSET'\\n\"");
__asm__(".ascii \"plcdata_const 'GROUP_REG_ADR'\\n\"");
__asm__(".ascii \"plcdata_const 'ERROR_COUNT_THRESH'\\n\"");
...
__asm__(".ascii \"plcdata_const 'ALARM_PATLITE_COMMS'\\n\"");
__asm__(".previous");
