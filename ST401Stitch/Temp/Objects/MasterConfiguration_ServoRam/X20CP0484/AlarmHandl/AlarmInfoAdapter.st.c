...
#include "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/AlarmHandl/AlarmInfoAdapterst.h"
#line 1 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AlarmControl/AlarmHandling/AlarmInfoAdapter.nodebug"
#line 3 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AlarmControl/AlarmHandling/AlarmInfoAdapter.st"
plcbit AlarmInfoAdapter(struct AlarmListAdapter_typ(* pAlarmListAdapter), struct MpAlarmXListUIAlarmListType(* AlarmList), unsigned long NumPendingAlarms){plcbit __AS__AlarmInfoAdapter=0;signed long zzIndex00000;unsigned short i=0;{


if((((unsigned long)NumPendingAlarms==(unsigned long)0))){
for((i=0);i<=49;i+=1){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Acknowledged[i]); plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Active[i]); plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Code[i]); plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}imp1_endfor1_0:;
}else{

for((i=0);i<=((*(AlarmList)).MaxSelection);i+=1){

if((((unsigned long)(unsigned char)((*(AlarmList)).StateAcknowledged[i])==(unsigned long)(unsigned char)1))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Acknowledged[i]); plcstring* zzRValue=(plcstring*)"Yes"; for(zzIndex=0; zzIndex<3l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}else{
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Acknowledged[i]); plcstring* zzRValue=(plcstring*)"No"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

if((((unsigned long)(unsigned char)((*(AlarmList)).StateActive[i])==(unsigned long)(unsigned char)1))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Active[i]); plcstring* zzRValue=(plcstring*)"Yes"; for(zzIndex=0; zzIndex<3l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}else{
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Active[i]); plcstring* zzRValue=(plcstring*)"No"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

brsitoa(((*(AlarmList)).Code[i]),((unsigned long)(&((*(pAlarmListAdapter)).Code[i]))));

}imp1_endfor2_0:;

for((i=(((*(AlarmList)).MaxSelection)+1));i<=49;i+=1){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Acknowledged[i]); plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Active[i]); plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(pAlarmListAdapter)).Code[i]); plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}imp1_endfor5_0:;
...
(__AS__AlarmInfoAdapter=1);

}return __AS__AlarmInfoAdapter;}
#line 42 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AlarmControl/AlarmHandling/AlarmInfoAdapter.nodebug"

void __AS__ImplInitAlarmInfoAdapter_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/AlarmHandl/AlarmInfoAdapter.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/AlarmHandl/AlarmInfoAdapter.st.c\\\" \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AlarmControl/AlarmHandling/AlarmInfoAdapter.st\\\"\\n\"");
