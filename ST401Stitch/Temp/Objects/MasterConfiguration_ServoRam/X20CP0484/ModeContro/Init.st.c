...
#include "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/ModeContro/Initst.h"
#line 1 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/ModeControl/ModeControl_ST/Init.nodebug"
#line 3 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/ModeControl/ModeControl_ST/Init.st"
...
*((char volatile*)&(gUserLevel)) = *((char*)&(gUserLevel));
*((char volatile*)&(gIO)) = *((char*)&(gIO));



(gIO.DIs.SafetyOK=1);
(gIO.SafetyStatus.BackEstopOK=1);
(gIO.SafetyStatus.FrontEStopOK=1);
(gIO.SafetyStatus.GuardDoorsOK=1);
(gIO.DIs.AirPressureOK=1);
(gIO.DIs.VacuumPressureOK=1);
(gIO.DIs.AdhesiveUnitNotFaulted=1);
(gIO.DIs.AdhesiveUnitReady=1);
(gIO.DIs.AdhesiveLevelLow=0);
(gIO.DIs.VacuumTempOK=1);
(gIO.DIs.BodyHopperLow=1);
...
(gHMI.Parameters.PickAndPlaceDwell=750);
(gHMI.Parameters.LowHopperTime=2000);
(gHMI.Parameters.LowFeedJamTime=3000);
(gHMI.Parameters.TopFeedJamTime=10000);
(gHMI.Parameters.VacuumOffTime=1000);
(gHMI.Parameters.DownPulseTime=1000);
(gHMI.Parameters.Y_DelayTime=500);
(gHMI.Parameters.BlowOffTime=100);
(gHMI.Parameters.LubeCycleCount=5);
(gHMI.Parameters.SetCycleCount=25000);

}}
#line 82 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/ModeControl/ModeControl_ST/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/ModeContro/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/ModeContro/Init.st.c\\\" \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/ModeControl/ModeControl_ST/Init.st\\\"\\n\"");
__asm__(".previous");

__asm__(".section \".plciec\"");
__asm__(".ascii \"plcdata_const 'gUserLevel'\\n\"");
__asm__(".ascii \"plcdata_const 'gPassword'\\n\"");
__asm__(".ascii \"plcdata_const 'gIO'\\n\"");
