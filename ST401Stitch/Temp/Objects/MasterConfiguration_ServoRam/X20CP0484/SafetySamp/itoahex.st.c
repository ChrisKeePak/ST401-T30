...
#include "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/SafetySamp/itoahexst.h"
#line 1 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AsSafetySolution/SafetySample/itoahex.nodebug"
#line 12 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AsSafetySolution/SafetySample/itoahex.st"
unsigned short itoahex(unsigned long value, unsigned long pString){unsigned short __AS__itoahex=0;unsigned char i_cvalue=0;unsigned long i_value=0;unsigned char i_counter=0;{

(i_value=value);

for((i_counter=0);i_counter<=7;i_counter+=1){
(i_cvalue=(unsigned char)(brmfloor((float)(((unsigned long)(i_value))/((unsigned long)((unsigned long)(RealExpt(16,(7-i_counter))>=0.0?RealExpt(16,(7-i_counter))+0.5:RealExpt(16,(7-i_counter))-0.5)))))>=0.0?brmfloor((float)(((unsigned long)(i_value))/((unsigned long)((unsigned long)(RealExpt(16,(7-i_counter))>=0.0?RealExpt(16,(7-i_counter))+0.5:RealExpt(16,(7-i_counter))-0.5)))))+0.5:brmfloor((float)(((unsigned long)(i_value))/((unsigned long)((unsigned long)(RealExpt(16,(7-i_counter))>=0.0?RealExpt(16,(7-i_counter))+0.5:RealExpt(16,(7-i_counter))-0.5)))))-0.5));
if((((unsigned long)(unsigned char)i_cvalue==(unsigned long)(unsigned char)0))){
brsmemset((pString+i_counter),48,1);
}else if(((((unsigned long)(unsigned char)i_cvalue>(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)i_cvalue<(unsigned long)(unsigned char)10)))){
brsitoa(i_cvalue,(pString+i_counter));
}else if((((unsigned long)(unsigned char)i_cvalue>=(unsigned long)(unsigned char)10))){
brsmemset((pString+i_counter),(i_cvalue+55),1);
}

if((((unsigned long)(unsigned char)i_cvalue>(unsigned long)(unsigned char)0))){
(i_value=(i_value-((unsigned long)(RealExpt(16,(7-i_counter))>=0.0?RealExpt(16,(7-i_counter))+0.5:RealExpt(16,(7-i_counter))-0.5)*i_cvalue)));
}
...
}return __AS__itoahex;}
#line 34 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AsSafetySolution/SafetySample/itoahex.nodebug"

void __AS__ImplInititoahex_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/SafetySamp/itoahex.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/SafetySamp/itoahex.st.c\\\" \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/AsSafetySolution/SafetySample/itoahex.st\\\"\\n\"");
