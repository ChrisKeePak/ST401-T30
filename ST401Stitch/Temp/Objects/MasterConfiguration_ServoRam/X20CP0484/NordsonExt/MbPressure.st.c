...
#include "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/NordsonExt/MbPressurest.h"
#line 1 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.nodebug"
#line 9 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.st"
void __BUR__ENTRY_INIT_FUNCT__(void){{

{int zzIndex; plcstring* zzLValue=(plcstring*)Station; plcstring* zzRValue=(plcstring*)"IF2.ST2"; for(zzIndex=0; zzIndex<7l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(ModbusRead.pStation=((unsigned long)(&Station)));
(ModbusWrite.pStation=((unsigned long)(&Station)));

}}
#line 15 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.nodebug"
#line 17 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.st"
void _CYCLIC __BUR__ENTRY_CYCLIC_FUNCT__(void){{

(Channel.PressureSetpoint=PressureSetpoint);

switch(ExtendedCommsState){

case 0:{
(Channel.ActualPressure=((float)Registers.ChannelActualPressureWord/1000));
(Tank.ActualLevel=Registers.TankActualLevelWord);
(Registers.ChannelSetPressureWord=(unsigned long)((Channel.PressureSetpoint*1000)>=0.0?(Channel.PressureSetpoint*1000)+0.5:(Channel.PressureSetpoint*1000)-0.5));
(ExtendedCommsState=1);

}break;case 1:{
if((((unsigned long)(unsigned short)ModbusRead.status==(unsigned long)(unsigned short)ERR_OK))){
(ModbusRead.enable=0);
(ExtendedCommsState=5);
}else if((((unsigned long)(unsigned short)ModbusRead.status==(unsigned long)(unsigned short)ERR_FUB_ENABLE_FALSE))){
(ModbusRead.startAddress=6103);
(ModbusRead.nrRegisters=2);
(ModbusRead.pData=((unsigned long)(&Registers.ChannelActualPressureWord)));
(ModbusRead.dataSize=8);
(ModbusRead.enable=1);
}

}break;case 5:{
if((((unsigned long)(unsigned short)ModbusWrite.status==(unsigned long)(unsigned short)ERR_OK))){
(ModbusWrite.enable=0);
(ExtendedCommsState=9);
}else if(((((unsigned long)(unsigned short)ModbusRead.status==(unsigned long)(unsigned short)ERR_FUB_ENABLE_FALSE))&WriteFlag)){
(ModbusWrite.startAddress=6203);
(ModbusWrite.nrRegisters=2);
(ModbusWrite.pData=((unsigned long)(&Registers.ChannelSetPressureWord)));
(ModbusWrite.dataSize=8);
(ModbusWrite.enable=1);
(WriteFlag=0);
}else if(((((unsigned long)(unsigned short)ModbusWrite.status==(unsigned long)(unsigned short)ERR_FUB_ENABLE_FALSE))&(WriteFlag^1))){
(ExtendedCommsState=9);
}
...
if((((unsigned long)(unsigned short)ModbusRead.status==(unsigned long)(unsigned short)ERR_OK))){
(ModbusRead.enable=0);
(ExtendedCommsState=0);
}else if((((unsigned long)(unsigned short)ModbusWrite.status==(unsigned long)(unsigned short)ERR_FUB_ENABLE_FALSE))){
(ModbusRead.startAddress=13002);
(ModbusRead.nrRegisters=1);
(ModbusRead.pData=((unsigned long)(&Registers.TankActualLevelWord)));
(ModbusRead.dataSize=4);
(ModbusRead.enable=1);
}

}break;case 10:{
if(((((unsigned long)(unsigned short)ModbusRead.status==(unsigned long)(unsigned short)ERR_FUB_ENABLE_FALSE))&(((unsigned long)(unsigned short)ModbusWrite.status==(unsigned long)(unsigned short)ERR_FUB_ENABLE_FALSE)))){
(ExtendedCommsState=0);
}else{
...
if((((((unsigned long)(unsigned short)ModbusRead.status>(unsigned long)(unsigned short)0))&(((unsigned long)(unsigned short)ModbusRead.status<(unsigned long)(unsigned short)65534)))|((((unsigned long)(unsigned short)ModbusWrite.status>(unsigned long)(unsigned short)0))&(((unsigned long)(unsigned short)ModbusWrite.status<(unsigned long)(unsigned short)65534))))){
(ExtendedCommsState=10);
}


mbReadHoldingRegisters(&ModbusRead);
mbWriteMultipleRegisters(&ModbusWrite);

}}
#line 88 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.nodebug"
#line 90 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.st"
void _EXIT __BUR__ENTRY_EXIT_FUNCT__(void){{


}}
#line 93 "C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.nodebug"

void __AS__ImplInitMbPressure_st(void){__BUR__ENTRY_INIT_FUNCT__();}
...
__asm__(".ascii \"iecfile \\\"Logical/Actuators/NordsonComm/NordsonExtendedComm/Types.typ\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Actuators/NordsonComm/NordsonExtendedComm/Variables.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/NordsonExt/MbPressure.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/NordsonExt/MbPressure.st.c\\\" \\\"C:/Users/Crims/OneDrive/Desktop/Programs/ST401Stitch/Logical/Actuators/NordsonComm/NordsonExtendedComm/MbPressure.st\\\"\\n\"");
__asm__(".previous");
