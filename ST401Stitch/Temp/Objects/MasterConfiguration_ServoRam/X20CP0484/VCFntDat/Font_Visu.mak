...
# Font calibri
#
ifneq ($(VC_FONT_calibri),1)
VC_FONT_calibri=1
$(AS_CPU_PATH)/VcFntDat/calibri.vco:$(AS_CPU_PATH)/VcFntDat/calibri.vci
	 $(VCC) -f '$<' -o '$@' $(TTFFLAGS_Visu) $(VCCFLAGS_Visu) -sfas

$(AS_CPU_PATH)/VcFntDat/calibri.ccf:$(AS_CPU_PATH)/VcFntDat/calibri.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m calibri.ttf -name Visu -profile 'False' -vcr 4720 -sfas

$(AS_CPU_PATH)/calibri.br:$(AS_CPU_PATH)/VcFntDat/calibri.ccf
...
FONT_MODULES_Visu=$(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/calibri.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arialbd.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arial.br 
